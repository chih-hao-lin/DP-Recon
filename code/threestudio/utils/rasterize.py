...
class NVDiffRasterizerContext:
    ...
    def initialize_context(
        ...
        if context_type == "gl":
            # return dr.RasterizeGLContext(device=device)               # OpenGL can't use in some server, use cuda instead (refer to https://nvlabs.github.io/nvdiffrast/#rasterizing-with-cuda-vs-opengl)
