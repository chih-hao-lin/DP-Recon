...
from threestudio.utils.ops import (shifted_cosine_decay,
...
class PromptProcessor(BaseObject):
    ...
    class Config(BaseObject.Config):
        ...
        negative_prompt: str = "shadow, oversaturated, low quality, unrealistic"
    ...
    def configure(self) -> None:
        ...
        if hasattr(self.cfg, "prefix"):
            self.prompt = self.cfg.prefix + self.prompt
